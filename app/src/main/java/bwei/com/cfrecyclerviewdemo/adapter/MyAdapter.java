package bwei.com.cfrecyclerviewdemo.adapter;
...
import bwei.com.cfrecyclerviewdemo.R;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View root) {
            ...
            image = (ImageView) root.findViewById(R.id.iv);
        }
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.title.setText(list.get(position).goods_name);
        Glide.with(context)
                .load(list.get(position).goods_img)
                .into(holder.image);
